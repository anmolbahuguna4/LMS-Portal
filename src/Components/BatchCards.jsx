...
function BatchCards() {
    ...
    const batch_cards = " bg-white m-5 p-6 border border-t-8 border-t-violet-800 rounded-3xl shadow-lg w-[25rem] h-[19rem] "
        ...
        <div className=" bg-slate-200 w-full flex flex-wrap ">
            <div className= {batch_cards}>
                <div className=" flex justify-between items-center ">
                    <div className=" text-violet-800 text-xl font-semibold ">4:30pm/FS/13-May</div>
                ...
                <button className=" border border-violet-800 bg-violet-800 text-white font-semibold rounded-md my-3 px-2 py-1 ">View Details</button>
            </div>
            <div className= {batch_cards}>
            <div className=" flex justify-between items-center ">
                    <div className=" text-violet-800 text-xl font-semibold ">10am/FS/nitin/9-sep</div>
            ...
            <div className= {batch_cards}>
            <div className=" flex justify-between items-center ">
                    <div className=" text-violet-800 text-xl font-semibold ">4:30pm/FS/14-Oct</div>
            ...
            <div className= {batch_cards}>
            <div className=" flex justify-between items-center ">
                    <div className=" text-violet-800 text-xl font-semibold ">3pm/DM/18-Nov</div>
                    <div><i className="fa-regular fa-user"></i> 16</div>
                </div>
                <div className=" flex flex-col gap-4 mt-4 font-semibold ">
